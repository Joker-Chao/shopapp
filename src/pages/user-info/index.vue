<template>
	<div class="page">
		<comment-header title="会员信息" :back="backUrl"></comment-header>
		<div class="user-info">
		...
		<awesome-picker ref="picker" type="date" colorConfirm="#ff5e46" @confirm="handlePickerConfirm"></awesome-picker>
	</div>
</template>
