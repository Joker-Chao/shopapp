...
<div class="page" ref="page">
	...
	<div class="history-time-container">
		<div class="history-time">
			<div class="history-time-cell" v-for="(item,index) of historyDays" :key="index">
	...
	<div class="history-list" v-show="showList" v-infinite-scroll="loadHistory" infinite-scroll-disabled="busy" infinite-scroll-distance="20">
...
export default {
	...
	methods:{
		...
		getHistoryTime(){
			...
			this.axios.get('shose/history/time',{
				headers:{
					token
				}
			}).then(res => this.historyDays = res)
		},
		async loadHistory(){
			this.busy = true
			this.$showLoading()
