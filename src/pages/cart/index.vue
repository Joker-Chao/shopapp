<template>
  <div class="page">
    ...
    <div class="cart-list">
      ...
      >
        ...
        >
          ...
          <div class="del" :data-goods-id="item.id" @click="delCartGoods">
            删除
          </div>
        </router-link>
      </div>
    ...
    <div class="cart-count border-top">
      ...
      <div class="settle" @click="submitCart">
        去结算<span v-if="cartNum !== 0">({{ cartNum }})</span>
      </div>
    </div>
...
export default {
  ...
  methods: {
    ...
    countCart() {
      ...
      this.selectAll =
        selectAll.length > 0 ? selectAll.length === this.cart.length : false;
...
.page {
  ...
  min-height: 100%;
  margin-top: $header-h;
  padding-bottom: $footer-h + 0.9rem;
  .cart-list {
    width: 100%;
    position: relative;
